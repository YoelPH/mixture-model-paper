...
contents.append(Histogram.from_hdf5(
  ...
  dataname=scenario.md5_hash("risks"),
  color=COLORS["blue"],
  label="advanced, lateralized; ipsi LNL III",
))
...
contents.append(Histogram.from_hdf5(
  ...
  dataname=scenario.md5_hash("risks"),
  color=COLORS["orange"],
  label="early, midline extension; N0",
))
...
contents.append(Histogram.from_hdf5(
  ...
  dataname=scenario.md5_hash("risks"),
  color=COLORS["red"],
  label="advanced, midline extension; ipsi LNL III",
))

draw(ax, contents, xlims=(0., 15.))
ax.legend(labelspacing=0.3)
ax.set_xlabel("risk [%]")
ax.set_yticks([])
ax.set_title("Predicted Risk of Contralateral LNL II Involvement\nfor Selected Diagnosis Scenarios")
