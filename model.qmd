...
for i, t_stage in enumerate(["early", "late"]):
  ...
  for j, midext in enumerate([False, True]):
    ...
    for ipsi, color in zip(
      [{"I": False, "II": False, "III": False, "IV": False, "V": False, "VII": False}, {"III": True}],
...
ax[1].set_yticks([])
ax[1].set_xticks(np.linspace(0, 15, 6))

ax[2].set_yticks([])
ax[2].set_xticks(np.linspace(0, 15, 6))
