...
for t_stage in ["early", "late"]:
  ...
  content.append(
    SummedBetaPosterior(
      num_success=combs.matches.values + beta_post.num_success,
      num_total=combs.total.values + beta_post.num_total,
      permutations=combs.permutations.values,
      kwargs={"linestyle": "--", "label": None, "color": "red"},
    )
  )
  print(f"{unknowns = }, {beta_post.num_success = }, {beta_post.num_total = }")
