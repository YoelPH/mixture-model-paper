...
plt.rcParams.update(shared.get_figsizes(nrows=nrows, ncols=ncols))
...
plt.rcParams.update(shared.get_fontsizes())
plt.rcParams.update(shared.get_figsizes(nrows=nrows, ncols=ncols, aspect_ratio=1.))
...
plt.rcParams.update(shared.get_fontsizes())
plt.rcParams.update(shared.get_figsizes(aspect_ratio=2.))
