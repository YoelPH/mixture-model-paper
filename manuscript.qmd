...
In this work we will stratify the tumor locations into different ICD codes which are depicted in @fig-subsites. For glottis tumors (C32.0), only t-stages T2,T3 and T4 have been taken into account as by definition glottis tumors are non-metastatic in the stages T0 and T1.
...
- $P(\mathbf{D}_k \mid \boldsymbol{\theta}_m)$ is the likelihood of patient $k$'s diagnosis, given that it was generated by model $m$,
