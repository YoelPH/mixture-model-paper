...
![3D state distribution of a midline model with 3 LNLs (II, III, and IV) in both sides of the neck. Note the higher probability for contralateral involvement in the right subplot, where the tumor extends over the mid-sagittal line.](figures/fig-model-state-dist.png){#fig-model-state-dist}
