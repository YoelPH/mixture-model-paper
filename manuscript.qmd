...
![Contralateral involvement stratified by T-category (left panel), the number of metastatic LNLs ipsilaterally (center panel), and whether the primary tumor extended over the mid-sagittal line or was clearly lateralized (right panel).](figures/fig_data_strat.svg){#fig-data-strat}
...
![3D state distribution of a midline model with 3 LNLs (II, III, and IV) in both sides of the neck. Note the higher probability for contralateral involvement in the right subplot, where the tumor extends over the mid-sagittal line.](figures/fig_model_state_dist.svg){#fig-model-state-dist}
