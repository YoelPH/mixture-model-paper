...
The component assignment is shown in @fig-4-matrix. Similarly to the 3-component model the different tumor locations are assigned to a one of the components. In this case, the new component is used to model laryngeal subsites. 
